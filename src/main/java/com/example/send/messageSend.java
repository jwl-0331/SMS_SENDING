...
public class messageSend {
	...
	public void send(String phone, String content) {
		...
		String accessKey = "VS6yu4bhI43eNgf1CYUp";
		String secretKey = "OhzgNDhGwr7h8AVE1jctv9rHgjBZuYg2TBv4swjs";
		String serviceId = "ncp:sms:kr:316360759422:sms_test1";
		String method = "POST";
		...
		bodyJson.put("from", "01048734882");//발신번호 , 사전 인증 등록된 번호
		//bodyJson.put("subject", ""); //메시지 제목, LMS TYPE 에서 사용
